...
<p>
  Close your Remote Desktop connection, delete the Resource Group(s) created at the beginning of this tutorial, and verify Resource Group deletion. You'll typically be notified or can click under the bell notification just to make sure that the Resource Group(s) have been deleted.
</p>
</p>
